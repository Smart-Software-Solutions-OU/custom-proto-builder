...
pub struct AccumulatorContent {
    ...
    pub accum_value: ::prost::alloc::vec::Vec<
...
impl ::prost::Name for AccumulatorContent {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "osmosis.accum.v1beta1.AccumulatorContent".into()
    }
...
impl ::prost::Name for Options {
    ...
    const PACKAGE: &'static str = "osmosis.accum.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "osmosis.accum.v1beta1.Options".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/osmosis.accum.v1beta1.Options".into()
    }
...
pub struct Record {
    ...
    pub accum_value_per_share: ::prost::alloc::vec::Vec<
        super::super::super::cosmos::base::v1beta1::DecCoin,
    >,
    ...
    pub unclaimed_rewards_total: ::prost::alloc::vec::Vec<
        super::super::super::cosmos::base::v1beta1::DecCoin,
    >,
...
impl ::prost::Name for Record {
    ...
    const PACKAGE: &'static str = "osmosis.accum.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "osmosis.accum.v1beta1.Record".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/osmosis.accum.v1beta1.Record".into()
    }
